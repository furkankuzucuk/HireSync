...
public interface IUserExamService
{
    ...
    Task<IEnumerable<UserExamDto>> GetUserExamByExamId(int examId, bool trackChanges);
    Task<IEnumerable<UserExamDto>> GetFilteredUserExams(int? userId, int? examId, bool trackChanges);
